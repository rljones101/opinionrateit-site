...
<template>
  <PageContainer id="profile">
    <div class="md:flex gap-4">
      <aside class="mb-24 md:pr-8 md:mb-0 md:w-3/12 flex-1" aria-label="Sidebar">
          ...
          >
            <div class="relative w-full max-w-2xl max-h-full">
              ...
              <div class="relative bg-slate-800 rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div
                  class="flex items-start justify-between p-5 border-b rounded-t border-slate-600"
                >
